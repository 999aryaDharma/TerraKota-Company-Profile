...
const FeatureCard = ({ title, description, image }: { title: string; description: string; image: string }) => {
	...
	return (
		<div onClick={handleClick} className="group relative overflow-hidden rounded-xl cursor-pointer">
			<div className="absolute inset-0 bg-cover bg-center transform transition-transform group-hover:scale-110" style={{ backgroundImage: `url(${image})` }} />
...
const Explore = () => {
	...
	const features = [
		...
		},
		{
			...
			image: "https://images.unsplash.com/photo-1585692612592-54e06c016fa4?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
		},
		{
			title: "Ruang Kolaborasi Tim",
			description: "Tempat ide hebat bermula dan berkembang bersama",
		...
		<div className="min-h-screen bg-gray-50 pt-20">
			...
			<div className="relative h-[60vh] flex items-center justify-center">
				...
				<div className="relative z-10 text-center px-4">
					<h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Jelajahi Teknologi Kami</h1>
					<p className="text-xl text-white/90 max-w-2xl mx-auto">Lihat bagaimana kami mengintegrasikan teknologi modern dengan pertanian urban</p>
				</div>
			</div>
			...
			<section className="py-20 px-4">
				<div className="max-w-7xl mx-auto">
					<h2 className="text-3xl font-bold text-emerald-900 text-center mb-12">Metrik Performa</h2>
			...
			<section className="py-20 bg-white px-4">
				<div className="max-w-7xl mx-auto">
					<h2 className="text-3xl font-bold text-emerald-900 text-center mb-12">Fitur Unggulan</h2>
			...
			<section className="py-20 px-4">
				<div className="max-w-7xl mx-auto text-center">
					<h2 className="text-3xl font-bold text-emerald-900 mb-6">Ingin Melihat Lebih Dekat?</h2>
					<p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">Jelajahi fasilitas kami melalui tur virtual atau kunjungi langsung greenhouse kami</p>
					<button className="px-8 py-4 bg-emerald-600 text-white rounded-full hover:bg-emerald-700 transition-colors text-lg font-medium">Mulai Tur Virtual</button>
				</div>
			</section>
		</div>
	);
